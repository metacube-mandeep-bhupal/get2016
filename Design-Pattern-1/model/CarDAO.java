...
/**
*
*Following class is CarDAO which interacts with database and facade layer to perform certain operations(insert new car data,read details of all cars and update an existing car).
*/
public class CarDAO {

	/**
	*
	*Following function insert a new car details in the existing database.
 	*carValueObject(CarValueobject) is the reference which holds the details of the car.
	*returns true/false whether the new car details are added or not.
	*/
	...
	/**
	*
	*Following function reads the list of cars from the existing database.
	*returns List of Cars which are present in the database.
	*/
	...
	/**
	*Following function update the details of the existing car in the database.
	*returns true/false whether the car details have been updated or not.
	*/
